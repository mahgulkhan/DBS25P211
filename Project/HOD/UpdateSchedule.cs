...
namespace Project.HOD
{
    public partial class UpdateSchedule : Form
    {
        ...
        public void Updateschedule()
        {
            ...
            int schedule_id = int.Parse(textBox3.Text);
            string day_of_week = "";
            ...
            ScheduleCrud scheduleCrud = new ScheduleCrud(schedule_id, faculty_id, room_id1, day_of_week, start_time, end_time);
            scheduleCrud.UpdateSchedule();
        }
        ...
        {
            if (string.IsNullOrEmpty(textBox1.Text)|| string.IsNullOrEmpty(textBox2.Text)|| string.IsNullOrEmpty(textBox3.Text)|| string.IsNullOrEmpty(comboBox1.Text) || string.IsNullOrEmpty(comboBox2.Text) || string.IsNullOrEmpty(comboBox3.Text))
            {
